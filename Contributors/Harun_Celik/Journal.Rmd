...
- **R**
 ...
 <details><summary>Click here for code:</summary>
  ...
  - With the Data Discovery Meeting coming up with the DHR Client, my task was to organize a number of different visuals to be placed into the presentation. Besides the work of the project interns, I was able to contribute with these two visualizations for ACS data.
